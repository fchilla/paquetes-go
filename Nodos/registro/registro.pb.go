...
func (x *RegRequest) GetBookData() string {
	if x, ok := x.GetData().(*RegRequest_BookData); ok {
		return x.BookData
	}
	return ""
}

func (x *RegRequest) GetIdNodo() int64 {
	if x, ok := x.GetData().(*RegRequest_IdNodo); ok {
		return x.IdNodo
	}
	return 0
}
...
type RegRequest_BookData struct {
	BookData string `protobuf:"bytes,1,opt,name=bookData,proto3,oneof"`
}

type RegRequest_IdNodo struct {
	IdNodo int64 `protobuf:"varint,2,opt,name=idNodo,proto3,oneof"`
}

type RegRequest_Chunk struct {
	Chunk *ChunkLoc `protobuf:"bytes,3,opt,name=chunk,proto3,oneof"`
}

func (*RegRequest_BookData) isRegRequest_Data() {}

func (*RegRequest_IdNodo) isRegRequest_Data() {}
...
var file_registro_proto_rawDesc = []byte{
	...
	,
...
var file_registro_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_registro_proto_goTypes = []interface{}{
	(*RegRequest)(nil), // 0: registro.RegRequest
	(*ChunkLoc)(nil),   // 1: registro.ChunkLoc
	(*RegReply)(nil),   // 2: registro.RegReply
}
var file_registro_proto_depIdxs = []int32{
	1, // 0: registro.RegRequest.chunk:type_name -> registro.ChunkLoc
	0, // 1: registro.Registro.EnviarRegistro:input_type -> registro.RegRequest
	2, // 2: registro.Registro.EnviarRegistro:output_type -> registro.RegReply
...
func file_registro_proto_init() {
	...
	file_registro_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*RegRequest_BookData)(nil),
		(*RegRequest_IdNodo)(nil),
